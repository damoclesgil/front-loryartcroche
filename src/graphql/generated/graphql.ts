...
export type QueryProdutosQuery = {
  __typename?: 'Query'
  produtos?: {
    __typename?: 'ProdutoEntityResponseCollection'
    data: Array<{
...
export const QueryProdutosDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'QueryProdutos' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'produtos' },
            selectionSet: {
              kind: 'SelectionSet',
              selections: [
                {
                      ...
                      { kind: 'Field', name: { kind: 'Name', value: 'id' } },
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            {
                              kind: 'Field',
                              name: { kind: 'Name', value: 'descricao' }
                            },
                            {
                              kind: 'Field',
                              name: { kind: 'Name', value: 'preco' }
                            },
                            {
                              kind: 'Field',
                              name: { kind: 'Name', value: 'imagem_destaque' },
                              selectionSet: {
                                kind: 'SelectionSet',
                                selections: [
                                  {
...
} as unknown as DocumentNode<QueryProdutosQuery, QueryProdutosQueryVariables>
export const GetProdutoDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      ...
      variableDefinitions: [
        {
          ...
          variable: {
            kind: 'Variable',
            name: { kind: 'Name', value: 'produtoId' }
          },
...
} as unknown as DocumentNode<GetProdutoQuery, GetProdutoQueryVariables>
